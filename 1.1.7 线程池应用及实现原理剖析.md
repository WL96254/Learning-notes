...
![img](/images/1.1.7 线程池.PNG)

### 线程池API - 接口定义和实现类

![img](/images/1.1.7 线程池API.PNG)
...
![img](/images/1.1.7 ExecutorService方法定义.PNG) 

**ScheduledExecutorService**

![img](/images/1.1.7 ScheduledExecutorService方法定义.PNG) 
...
![img](/images/1.1.7 线程池任务执行过程.PNG)  
